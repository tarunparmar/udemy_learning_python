...
def deal_card(frame):
    ...
    next_card = deck.pop(0)  # (0) to grab card from top of deck
...
def score_hand(hand):
    ...
    # only once ace can have the value 11, and this will be reduce to
    # 1 if hand would bust
    score = 0
    ace = False
    for next_card in hand:
        ...
        if card_value == 1 and not ace:
            ...
            card_value = 11
        score += card_value
        # if we could  bust, check if there an ace and subtract 10
        if score > 21 and ace:
            score -= 10
            ace = False
    return score
...
def deal_player():
    ...
    ## First code
    #############
    # global player_score  # telling function to use global variables
    # global player_ace
